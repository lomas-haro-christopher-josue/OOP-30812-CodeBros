...
public class FrmShowStock extends javax.swing.JFrame {
    ...
    public FrmShowStock() {
        ...
        cmbStockCategory.addActionListener(new java.awt.event.ActionListener() {
            @Override
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                loadStockFromMongoDB();
            }
        });
    }
...
private void loadStockFromMongoDB() {
        ...
        try {
            ...
            for (org.bson.Document doc : documents) {
                ...
                if (stock < 10) {
                    criticalProductsMessage.append("- ").append(name)
                                           .append(" (Quedan solo ").append(stock).append(" unidades)\n");
                }
            }
            ...
            if (criticalProductsMessage.length() > 0) {
                JOptionPane.showMessageDialog(this, 
                    ...
                    "\nPor favor, reabastecer lo más pronto posible.", 
            ...
            JOptionPane.showMessageDialog(this, 
                "Error al conectar con el inventario de MongoDB Atlas: " + e.getMessage(), 
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CONTROL DE INVERNTARIO ");

        jLabel2.setText("Seleccione una Categoría para Inspeccionar:");

        cmbStockCategory.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Seleccione una categoría...", "Snacks", "Bebidas normales o jugos", "Gaseosas", "Bebidas alcoholicas", "Dulces", "Galletas", "Productos de aseo personal" }));
        ...
        tblStock.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nombre", "Categoría", "Precio", "Stock Actual"
            }
        ) {
    ...
    try {
            ...
            java.util.logging.Logger.getLogger(FrmShowStock.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }

        java.awt.EventQueue.invokeLater(() -> {
            new FrmShowStock().setVisible(true);
        });
