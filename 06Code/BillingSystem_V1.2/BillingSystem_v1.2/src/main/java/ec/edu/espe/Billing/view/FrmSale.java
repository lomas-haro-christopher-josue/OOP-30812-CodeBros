...
public class FrmSale extends javax.swing.JFrame {
    ...
    private void btnRegisterSaleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegisterSaleActionPerformed
        ...
        try {
           ...
           try{
           com.mongodb.client.MongoCollection<org.bson.Document> invoiceCollection = database.getCollection("Invoices");
                
                
                double subtotalCalculado = totalSales / 1.15;
                double ivaCalculado = totalSales - subtotalCalculado;
                
                
                subtotalCalculado = Math.round(subtotalCalculado * 100.0) / 100.0;
                ivaCalculado = Math.round(ivaCalculado * 100.0) / 100.0;
                
                org.bson.Document invoiceDoc = new org.bson.Document("invoiceNumber", invoiceNum)
                        .append("customerRuc", customerRuc)
                        .append("subtotal", subtotalCalculado)
                        .append("iva", ivaCalculado)
                        .append("total", totalSales)
                        .append("cashier", cashier)
                        .append("paymentMethod", paymentMethod)
                ...
                System.out.println("Colección Invoices actualizada con éxito.");
                
            } catch (Exception ex) {
                System.out.println("Error al insertar en Invoices (Pero la venta se guardó): " + ex.getMessage());     
            }
